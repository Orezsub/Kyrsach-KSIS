...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Btn_Mute_Mic = QtWidgets.QPushButton(self.centralwidget)
        self.Btn_Mute_Mic.setGeometry(QtCore.QRect(650, 280, 76, 31))
        self.Btn_Mute_Mic.setObjectName("Btn_Mute_Mic")
